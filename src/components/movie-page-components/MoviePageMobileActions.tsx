...
export default function MoviePageMobileActions({
  movie,
  userId,
  username,
}: {
  ...
  return (
    <div
      key={movie.title}
      className="mx-[4%] mt-[10px] flex-1 translate-y-10 transform animate-fade-in-up opacity-0 delay-300"
    >
      <AddToListButtonWrapper
        ...
        triggerComponent={
          <button
            className={`mb-[10px] flex w-full items-center justify-center gap-2 rounded-full bg-main-color py-2 transition duration-300 ease-in-out hover:bg-main-color-dark active:bg-main-color-darkest`}
          >
